...
const Transition = p => {
  ...
  function renderChild() {
    const childRef = typeof local.children === "function" ? local.children(status(), childProps) : children(() => local.children)();
    return childRef;
  }

  return createComponent(TransitionGroupContext.Provider, {
    value: null,
