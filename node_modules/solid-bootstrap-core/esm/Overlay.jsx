...
const Overlay = (props) => {
    ...
    return (<Show when={container() && popperVisible()}>
      <Portal mount={container()}>
        {Transition ? (<Transition appear in={props.show} onExit={props.onExit} onExiting={props.onExiting} onExited={handleHidden} onEnter={props.onEnter} onEntering={props.onEntering} onEntered={props.onEntered}>
            <InnerChild />
