...
export declare type TransitionWrapperChildFunction = (status: TransitionStatus, props: Record<string, unknown>) => JSX.Element;
export declare type TransitionWrapperProps = Omit<TransitionProps, "addEndListener" | "onEnter" | "onEntering" | "onEntered" | "onExit" | "onExiting" | "onExited"> & {
