...
const Modal = (p) => {
    ...
    const renderBackdrop = (backdropProps) => (<div {...backdropProps} className={classNames(`${bsPrefix}-backdrop`, local.backdropClassName, !local.animation && "show")}>
    ...
    const renderDialog = (dialogProps) => (<div role="dialog" {...dialogProps} style={baseModalStyle()} className={classNames(local.className, bsPrefix, animateStaticModal() && `${bsPrefix}-static`)} onClick={local.backdrop ? handleClick : undefined} onMouseUp={handleMouseUp} aria-labelledby={local["aria-labelledby"]}>
      <Dynamic component={local.dialogAs} {...props} onMouseDown={handleDialogMouseDown} className={local.dialogClassName} contentClassName={local.contentClassName}>
        {local.children}
      </Dynamic>
    </div>);
