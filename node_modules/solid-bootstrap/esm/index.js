import { createComponent, mergeProps as mergeProps$1, Dynamic, template, spread, insert, effect, memo, setAttribute, delegateEvents, style as style$1, isServer, addEventListener as addEventListener$1 } from 'solid-js/web';
...
const TransitionWrapper = p => {
  ...
  function renderChild() {
    if (typeof local.children === "function") {
      ...
      return (status, innerProps) => local.children?.(status, { ...innerProps,
        ref: mergedRef
      });
    } else {
...
const Collapse = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$1c, p), ["onEnter", "onEntering", "onEntered", "onExit", "onExiting", "className", "children", "dimension", "getDimensionValue"]);
  /* Compute dimension */
...
const AccordionCollapse = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$1b, p), ["as", "bsPrefix", "className", "children", "eventKey"]);
  ...
  return createComponent(Collapse$1, mergeProps$1({
    ...
    get children() {
      return createComponent(Dynamic, {
        ...
        get className() {
          return classNames(local.className, bsPrefix);
        },
...
const AccordionBody = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$1a, p), ["as", "bsPrefix", "className"]);
...
const AccordionButton = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$19, p), ["as", "bsPrefix", "className", "onClick"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsPrefix, !isAccordionItemSelected(accordionContext.activeEventKey, itemContext.eventKey) && "collapsed");
    },
...
const AccordionHeader = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$18, p), ["as", "bsPrefix", "className", "children", "onClick"]);
...
const AccordionItem = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$17, p), ["as", "bsPrefix", "className", "eventKey"]);
...
const Accordion = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$16, p), ["as", "activeKey", "alwaysOpen", "bsPrefix", "className", "defaultActiveKey", "onSelect", "flush"]);
  ...
  return createComponent(AccordionContext.Provider, {
    ...
    get children() {
      return createComponent(Dynamic, mergeProps$1({
        ...
        get className() {
          return classNames(local.className, prefix, local.flush && `${prefix}-flush`);
        },
...
const Fade = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$15, p), ["className", "children", "transitionClasses"]);
  ...
  return createComponent(TransitionWrapper$1, mergeProps$1({
    ...
    children: (status, innerProps) => {
      ...
      innerProps.ref(el);
      const newClasses = classNames("fade", local.className, // @ts-ignore
...
const CloseButton = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$14, p), ["className", "variant"]);
  return (() => {
    ...
    effect(() => _el$.className = classNames("btn-close", local.variant && `btn-close-${local.variant}`, local.className));
...
const divWithClassName = className => p => {
  return (() => {
    ...
    spread(_el$, p, false, true);

    insert(_el$, () => p.children);

    effect(() => _el$.className = classNames(p.className, className));
...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = p => {
    const [local, props] = splitProps(mergeProps({
      as: Component || "div"
    }, defaultProps, p), ["className", "bsPrefix", "as"]);
    ...
    return createComponent(Dynamic, mergeProps$1({
      ...
      get className() {
        return classNames(local.className, resolvedPrefix);
      }
...
const _tmpl$$p = template(`<div role="alert"></div>`, 2);
...
const Alert = uncontrolledProps => {
  const [local, props] = splitProps(mergeProps(defaultProps$13, uncontrolledProps), ["bsPrefix", "children", "defaultShow", "show", "closeLabel", "closeVariant", "className", "children", "variant", "onClose", "dismissible", "transition"]);
  ...
  const alert = () => (() => {
    ...
    effect(() => _el$.className = classNames(local.className, prefix, local.variant && `${prefix}-${local.variant}`, local.dismissible && `${prefix}-dismissible`));
...
const Badge = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$12, p), ["as", "bsPrefix", "bg", "pill", "text", "className"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, prefix, local.pill && `rounded-pill`, local.text && `text-${local.text}`, local.bg && `bg-${local.bg}`);
    },
...
const BreadcrumbItem = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$11, p), ["bsPrefix", "active", "children", "className", "as", "linkAs", "linkProps", "href", "title", "target"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(prefix, local.className, {
        active: local.active
      });
    },
...
const _tmpl$$o = template(`<ol></ol>`, 2);
...
const Breadcrumb = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$10, p), ["bsPrefix", "className", "listProps", "children", "label", "as"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get children() {
      ...
      effect(() => _el$.className = classNames(prefix, local.listProps?.className));
...
const Button = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$$, p), ["as", "bsPrefix", "variant", "size", "active", "className"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, prefix, local.active && "active", local.variant && `${prefix}-${local.variant}`, local.size && `${prefix}-${local.size}`, props.href && props.disabled && "disabled");
    },
...
const ButtonGroup = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$_, p), ["bsPrefix", "size", "vertical", "className", "as"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, baseClass, local.size && `${prefix}-${local.size}`);
    },
...
const _tmpl$$n = template(`<div></div>`, 2);
const defaultProps$Z = {
  role: "toolbar"
};

const ButtonToolbar = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$Z, p), ["bsPrefix", "className"]);
  ...
  return (() => {
    ...
    effect(() => _el$.className = classNames(local.className, prefix));
...
const CardImg = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$Y, p), ["as", "bsPrefix", "className", "variant"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.variant ? `${prefix}-${local.variant}` : prefix, local.className);
    }
...
const CardHeader = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$X, p), ["as", "bsPrefix", "className"]);
  ...
  return createComponent(CardHeaderContext.Provider, {
    ...
    get children() {
      return createComponent(Dynamic, mergeProps$1({
        ...
        get className() {
          return classNames(local.className, prefix);
        },
...
const Card = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$W, p), ["as", "bsPrefix", "className", "bg", "text", "border", "body", "children"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, prefix, local.bg && `bg-${local.bg}`, local.text && `text-${local.text}`, local.border && `border-${local.border}`);
    },
...
const CarouselItem = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$V, p), ["as", "bsPrefix", "className", "interval"]); // custom response to allow <Carousel /> to access interval
  ...
  return {
    item: createComponent(Dynamic, mergeProps$1({
      ...
      get className() {
        return classNames(local.className, useBootstrapPrefix(local.bsPrefix, "carousel-item"));
      },
...
const _tmpl$$m = template(`<div></div>`, 2),
      _tmpl$2$5 = template(`<button type="button" data-bs-target=""></button>`, 2),
      _tmpl$3$2 = template(`<span aria-hidden="true" class="carousel-control-prev-icon"></span>`, 2),
      _tmpl$4 = template(`<span class="visually-hidden"></span>`, 2),
      _tmpl$5 = template(`<span aria-hidden="true" class="carousel-control-next-icon"></span>`, 2);
...
const Carousel = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$U, p), ["as", "bsPrefix", "slide", "fade", "controls", "indicators", "indicatorLabels", "activeIndex", "defaultActiveIndex", "onSelect", "onSlide", "onSlid", "interval", "keyboard", "onKeyDown", "pause", "onMouseOver", "onMouseOut", "wrap", "touch", "onTouchStart", "onTouchMove", "onTouchEnd", "prevIcon", "prevLabel", "nextIcon", "nextLabel", "variant", "className", "children", "ref"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, prefix, local.slide && "slide", local.fade && `${prefix}-fade`, local.variant && `${prefix}-${local.variant}`);
    },
...
const Col = p => {
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, !meta.spans.length && meta.bsPrefix);
    },
...
const Container = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$T, p), ["as", "bsPrefix", "fluid", "className"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, local.fluid ? `${prefix}${suffix}` : prefix);
    },
...
const DropdownItem = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$S, p), ["as", "bsPrefix", "className", "eventKey", "disabled", "onClick", "active"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, prefix, meta.isActive && "active", local.disabled && "disabled");
    },
...
const DropdownMenu = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$R, p), ["as", "bsPrefix", "className", "align", "rootCloseEvent", "flip", "show", "renderOnMount", "popperConfig", "ref", "variant"]);
  let alignEnd = false;
  ...
  return createComponent(Show, {
    ...
    get children() {
      return createComponent(Dynamic, mergeProps$1({
        ...
        get className() {
          return classNames(local.className, prefix, menuMeta.show && "show", alignEnd && `${prefix}-end`, local.variant && `${prefix}-${local.variant}`, ...alignClasses);
        },
...
const DropdownToggle = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$Q, p), ["as", "bsPrefix", "split", "className", "childBsPrefix", "ref"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, prefix, local.split && `${prefix}-split`, !!isInputGroup && dropdownContext?.show && "show");
    }
...
const Dropdown = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$P, p), ["as", "bsPrefix", "drop", "show", "defaultShow", "className", "align", "onSelect", "onToggle", "focusFirstItemOnShow", "navbar", "autoClose"]);
      ...
      return createComponent(Dropdown$2, {
        ...
        get children() {
          return isInputGroup ? props.children : createComponent(Dynamic, mergeProps$1({
            ...
            get className() {
              return classNames(local.className, show() && "show", (!local.drop || local.drop === "down") && prefix, local.drop === "up" && "dropup", local.drop === "end" && "dropend", local.drop === "start" && "dropstart");
            },
...
const Feedback = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$N, p), ["as", "className", "type", "tooltip"]);
  return createComponent(Dynamic, mergeProps$1({
    get component() {
      return local.as;
    }
    ...
    get className() {
      return classNames(local.className, `${local.type}-${local.tooltip ? "tooltip" : "feedback"}`);
    },
...
const Image = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$M, p), ["bsPrefix", "className", "fluid", "rounded", "roundedCircle", "thumbnail"]);
  ...
  return (() => {
    ...
    effect(() => _el$.className = classNames(local.className, local.fluid && `${bsPrefix}-fluid`, local.rounded && `rounded`, local.roundedCircle && `rounded-circle`, local.thumbnail && `${bsPrefix}-thumbnail`));
...
const FigureImage = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$L, p), ["className"]);
  return createComponent(Image$1, mergeProps$1(props, {
    get className() {
      return classNames(local.className, "figure-img");
    },
...
const _tmpl$$k = template(`<label></label>`, 2);
const defaultProps$J = {};

const FloatingLabel = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$J, p), ["bsPrefix", "className", "children", "controlId", "label"]);
...
const FormCheckInput = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$I, p), ["as", "id", "bsPrefix", "className", "type", "isValid", "isInvalid"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsPrefix, local.isValid && "is-valid", local.isInvalid && "is-invalid");
    },
...
const _tmpl$$j = template(`<label></label>`, 2);
const defaultProps$H = {};

const FormCheckLabel = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$H, p), ["bsPrefix", "className", "htmlFor"]);
  ...
  return (() => {
    ...
    effect(_p$ => {
      const _v$ = local.htmlFor || formContext.controlId,
            _v$2 = classNames(local.className, bsPrefix);
...
const FormCheck = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$G, p), ["as", "id", "bsPrefix", "bsSwitchPrefix", "inline", "disabled", "isValid", "isInvalid", "feedbackTooltip", "feedback", "feedbackType", "className", "style", "title", "type", "label", "children"]);
  ...
  const hasLabel = createMemo(() => local.label != null && local.label !== false && !local.children || hasFormCheckLabel());
  return createComponent(FormContext$1.Provider, {
    ...
    get children() {
      return createComponent(FormCheckContext$1.Provider, {
        ...
        get children() {
          ...
          insert(_el$, () => local.children || [createComponent(FormCheckInput$1, mergeProps$1(props, {
            get type() {
          ...
          effect(_p$ => {
            const _v$ = local.style,
                  _v$2 = classNames(local.className, hasLabel() && bsPrefix, local.inline && `${bsPrefix}-inline`, local.type === "switch" && bsSwitchPrefix);
...
const FormControl = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$F, p), ["as", "bsPrefix", "type", "size", "htmlSize", "id", "className", "isValid", "isInvalid", "plaintext", "readOnly"]);
  const formContext = useContext(FormContext$1);
...
const FormLabel = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$E, p), ["as", "bsPrefix", "column", "visuallyHidden", "className", "htmlFor"]);
  const formContext = useContext(FormContext$1);
...
const _tmpl$$h = template(`<input type="range">`, 1);
...
const _tmpl$$g = template(`<select></select>`, 2);
...
const FormSelect = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$C, p), ["bsPrefix", "size", "htmlSize", "className", "isValid", "isInvalid", "id"]);
  const formContext = useContext(FormContext$1);
  ...
  return (() => {
    ...
    effect(_p$ => {
      const _v$ = local.htmlSize,
            _v$2 = classNames(local.className, bsPrefix, local.size && `${bsPrefix}-${local.size}`, local.isValid && `is-valid`, local.isInvalid && `is-invalid`),
...
const FormText = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$B, p), ["as", "bsPrefix", "className", "muted"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsPrefix, local.muted && "text-muted");
    },
...
const Form = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$A, p), ["as", "className", "validated"]);
  return createComponent(Dynamic, mergeProps$1({
    get component() {
      return local.as;
    }
    ...
    get className() {
      return classNames(local.className, local.validated && "was-validated");
    },
...
const InputGroup = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$z, p), ["as", "bsPrefix", "size", "hasValidation", "className"]);
  ...
  return createComponent(InputGroupContext.Provider, {
    ...
    get children() {
      return createComponent(Dynamic, mergeProps$1({
        ...
        get className() {
          return classNames(local.className, bsPrefix, local.size && `${bsPrefix}-${local.size}`, local.hasValidation && "has-validation");
        },
...
const ListGroupItem = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$y, p), ["as", "bsPrefix", "active", "disabled", "eventKey", "className", "variant", "action"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsPrefix, meta.isActive && "active", local.disabled && "disabled", local.variant && `${bsPrefix}-${local.variant}`, local.action && `${bsPrefix}-action`);
    },
...
const ListGroup = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$x, p), ["as", "activeKey", "defaultActiveKey", "bsPrefix", "className", "variant", "horizontal", "numbered", "onSelect"]);
  const [activeKey, onSelect] = createControlledProp(() => local.activeKey, () => local.defaultActiveKey, local.onSelect);
  ...
  return createComponent(Nav$2, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsPrefix, local.variant && `${bsPrefix}-${local.variant}`, horizontalVariant && `${bsPrefix}-${horizontalVariant}`, local.numbered && `${bsPrefix}-numbered`);
    },
...
const _tmpl$$f = template(`<div><div></div></div>`, 4);
const defaultProps$w = {};

const ModalDialog = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$w, p), ["bsPrefix", "className", "contentClassName", "centered", "size", "fullscreen", "children", "scrollable"]);
  ...
  return (() => {
    ...
    effect(_p$ => {
      const _v$ = classNames(dialogClass, local.className, local.size && `${bsPrefix}-${local.size}`, local.centered && `${dialogClass}-centered`, local.scrollable && `${dialogClass}-scrollable`, local.fullscreen && fullScreenClass),
            _v$2 = classNames(`${bsPrefix}-content`, local.contentClassName);
...
const _tmpl$$e = template(`<div></div>`, 2);
const defaultProps$v = {
  closeLabel: "Close",
  closeButton: false
};
...
const ModalHeader = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$u, p), ["bsPrefix", "className"]);
...
const _tmpl$$d = template(`<div></div>`, 2),
      _tmpl$2$4 = template(`<div role="dialog"></div>`, 2);
const defaultProps$t = {
  show: false,
  backdrop: true,
  keyboard: true,
...
const Modal = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$t, p), ["bsPrefix", "className", "style", "dialogClassName", "contentClassName", "children", "dialogAs", "aria-labelledby",
  /* BaseModal props */
  "show", "animation", "backdrop", "keyboard", "onEscapeKeyDown", "onShow", "onHide", "container", "autoFocus", "enforceFocus", "restoreFocus", "restoreFocusOptions", "onEntered", "onExit", "onExiting", "onEnter", "onEntering", "onExited", "backdropClassName", "manager"]);
  ...
  const renderBackdrop = backdropProps => (() => {
    ...
    insert(_el$, () => backdropProps.children);

    effect(() => _el$.className = classNames(`${bsPrefix}-backdrop`, local.backdropClassName, !local.animation && "show"));
  ...
  const renderDialog = dialogProps => (() => {
    ...
    insert(_el$2, createComponent(Dynamic, mergeProps$1({
      ...
      get className() {
        return local.dialogClassName;
      },

      get contentClassName() {
        return local.contentClassName;
      },
    ...
    effect(_p$ => {
      const _v$ = baseModalStyle(),
            _v$2 = classNames(local.className, bsPrefix, animateStaticModal() && `${bsPrefix}-static`),
...
const NavLink = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$s, p), ["as", "bsPrefix", "className", "active", "eventKey"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsPrefix, props.disabled && "disabled", meta.isActive && "active");
    },
...
const Nav = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$r, p), ["as", "activeKey", "defaultActiveKey", "bsPrefix", "variant", "fill", "justify", "navbar", "navbarScroll", "className", "onSelect"]);
  const [activeKey, onSelect] = createControlledProp(() => local.activeKey, () => local.defaultActiveKey, local.onSelect);
  ...
  return createComponent(Nav$2, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, {
        [bsPrefix]: !isNavbar,
...
const NavbarBrand = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$q, p), ["as", "bsPrefix", "className"]);
...
const _tmpl$$c = template(`<div></div>`, 2);
const defaultProps$p = {};

const NavbarCollapse = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$p, p), ["bsPrefix", "className", "children", "ref"]);
  ...
  return createComponent(Collapse$1, mergeProps$1({
    ...
    get children() {
      ...
      effect(() => _el$.className = classNames(bsPrefix, local.className));
...
const _tmpl$$b = template(`<span></span>`, 2);
const defaultProps$o = {
  as: "button",
...
const NavbarToggle = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$o, p), ["as", "bsPrefix", "className", "children", "label", "onClick"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsPrefix, !context?.expanded && "collapsed");
    },
...
const OffcanvasToggling = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$n, p), ["bsPrefix", "className", "children"]);
  ...
  return createComponent(TransitionWrapper$1, mergeProps$1({
    ...
    children: (status, innerProps) => {
      const el = child();
      innerProps.ref(el);
      const newClasses = classNames(local.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, // @ts-ignore
...
const OffcanvasHeader = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$m, p), ["bsPrefix", "className"]);
...
const _tmpl$$a = template(`<div></div>`, 2),
      _tmpl$2$3 = template(`<div role="dialog"></div>`, 2);
const defaultProps$l = {
  show: false,
  backdrop: true,
  keyboard: true,
...
function DialogTransition(props) {
  return createComponent(OffcanvasToggling$1, mergeProps$1(props, {
    get children() {
      return props.children;
    }
...
const Offcanvas = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$l, p), ["bsPrefix", "className", "children", "aria-labelledby", "placement",
  /*BaseModal props */
  "show", "backdrop", "keyboard", "scroll", "onEscapeKeyDown", "onShow", "onHide", "container", "autoFocus", "enforceFocus", "restoreFocus", "restoreFocusOptions", "onEntered", "onExit", "onExiting", "onEnter", "onEntering", "onExited", "backdropClassName", "manager", "ref"]);
  let modalManager;
  const bsPrefix = useBootstrapPrefix(local.bsPrefix, "offcanvas");
  const navbarContext = useContext(NavbarContext);
  ...
  const renderBackdrop = backdropProps => (() => {
    ...
    effect(() => _el$.className = classNames(`${bsPrefix}-backdrop`, local.backdropClassName));
  ...
  const renderDialog = dialogProps => (() => {
    ...
    effect(_p$ => {
      const _v$ = classNames(local.className, bsPrefix, `${bsPrefix}-${local.placement}`),
...
const Navbar = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$k, p), ["as", "bsPrefix", "expand", "variant", "bg", "fixed", "sticky", "className", "expanded", "defaultExpanded", "onToggle", "onSelect", "collapseOnSelect"]);
      ...
      return createComponent(SelectableContext.Provider, {
        ...
        get children() {
          return createComponent(Dynamic, mergeProps$1({
            ...
            get className() {
              return classNames(local.className, bsPrefix, local.expand && expandClass(), local.variant && `${bsPrefix}-${local.variant}`, local.bg && `bg-${local.bg}`, local.sticky && `sticky-${local.sticky}`, local.fixed && `fixed-${local.fixed}`);
            },
...
const NavDropdown = p => {
  ...
  const [local, props] = splitProps(mergeProps(defaultProps$j, p), ["id", "title", "children", "bsPrefix", "className", "rootCloseEvent", "menuRole", "disabled", "active", "renderMenuOnMount", "menuVariant"]);
  const navItemPrefix = useBootstrapPrefix(undefined, "nav-item");
  return createComponent(Dropdown$1, mergeProps$1(props, {
    get className() {
      return classNames(local.className, navItemPrefix);
    },
...
const _tmpl$$9 = template(`<li></li>`, 2),
      _tmpl$2$2 = template(`<span class="visually-hidden"></span>`, 2),
      _tmpl$3$1 = template(`<span aria-hidden="true"></span>`, 2);
const defaultProps$g = {
  active: false,
  disabled: false,
  activeLabel: "(current)"
...
const PageItem = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$g, p), ["active", "disabled", "className", "style", "activeLabel", "children", "ref"]);
  return (() => {
    ...
    effect(_p$ => {
      const _v$ = local.style,
            _v$2 = classNames(local.className, "page-item", {
        active: local.active,
...
const _tmpl$$8 = template(`<ul></ul>`, 2);
const defaultProps$f = {};
/**
...
const Pagination = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$f, p), ["bsPrefix", "className", "size"]);
  ...
  return (() => {
    ...
    effect(() => _el$.className = classNames(local.className, decoratedBsPrefix, local.size && `${decoratedBsPrefix}-${local.size}`));
...
const Placeholder = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$e, p), ["as"]);
  return createComponent(Dynamic, mergeProps$1({
    get component() {
      return local.as;
    }
...
const _tmpl$$7 = template(`<div role="tooltip"><div class="popover-arrow"></div></div>`, 4);
const defaultProps$d = {
  arrowProps: {},
  placement: "right"
};
...
const Popover = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$d, p), ["bsPrefix", "placement", "className", "style", "children", "body", "arrowProps", "popper", "show"]);
  ...
  return (() => {
    ...
    setAttribute(_el$, "x-placement", primaryPlacement);
    ...
    effect(_p$ => {
      const _v$ = classNames(local.className, decoratedBsPrefix, primaryPlacement && `bs-popover-auto`),
            _v$2 = Object.assign({}, local.style, context?.wrapperProps.style);
...
const _tmpl$$6 = template(`<div role="progressbar"></div>`, 2),
      _tmpl$2$1 = template(`<span class="visually-hidden"></span>`, 2),
      _tmpl$3 = template(`<div></div>`, 2);
...
function renderProgressBar(p) {
  const [local, props] = splitProps(p, ["min", "now", "max", "label", "visuallyHidden", "striped", "animated", "className", "style", "variant", "bsPrefix"]);
  ...
  return (() => {
    ...
    effect(_p$ => {
      const _v$ = classNames(local.className, `${bsPrefix}-bar`, {
...
const ProgressBar = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$c, p), ["children", "className", "bsPrefix"]);
  const bsPrefix = useBootstrapPrefix(local.bsPrefix, "progress");
  ...
  return context?.isStacked ? renderProgressBar(barProps) : createComponent(ProgressContext.Provider, {
    ...
    get children() {
      ...
      effect(() => _el$3.className = classNames(local.className, bsPrefix));
...
const Row = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$b, p), ["as", "bsPrefix", "className"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, decoratedBsPrefix, ...classes);
    },
...
const Spinner = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$a, p), ["as", "bsPrefix", "variant", "animation", "size", "className"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsSpinnerPrefix, local.size && `${bsSpinnerPrefix}-${local.size}`, local.variant && `text-${local.variant}`);
    },
...
const _tmpl$$5 = template(`<span class="visually-hidden"></span>`, 2);
...
const Stack = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$8, p), ["as", "bsPrefix", "className", "direction", "gap"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(local.className, bsPrefix, ...createUtilityClassName({
        gap: local.gap,
...
const TabPane = p => {
  ...
  const [panelLocal, rest] = splitProps(panelProps, ["as", "className", "mountOnEnter", "unmountOnExit"]);
          ...
          return createComponent(Transition, {
            ...
            get children() {
              return createComponent(Dynamic, mergeProps$1({
                ...
                get className() {
                  return classNames(panelLocal.className, prefix, meta.isActive && "active");
                },
...
const _tmpl$$4 = template(`<table></table>`, 2),
      _tmpl$2 = template(`<div></div>`, 2);
const defaultProps$5 = {};

const Table = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$5, p), ["bsPrefix", "className", "striped", "bordered", "borderless", "hover", "size", "variant", "responsive"]);
  const decoratedBsPrefix = useBootstrapPrefix(local.bsPrefix, "table");

  const classes = () => classNames(local.className, decoratedBsPrefix, local.variant && `${decoratedBsPrefix}-${local.variant}`, local.size && `${decoratedBsPrefix}-${local.size}`, local.striped && `${decoratedBsPrefix}-striped`, local.bordered && `${decoratedBsPrefix}-bordered`, local.borderless && `${decoratedBsPrefix}-borderless`, local.hover && `${decoratedBsPrefix}-hover`);
      ...
      return [createComponent(Nav$1, mergeProps$1(props, {
        ...
        get children() {
          return createComponent(For, {
            ...
            children: tabProps => createComponent(RenderTab, mergeProps$1(tabProps, {
              get children() {
                return tabProps.children;
              }
        ...
        get children() {
          return createComponent(For, {
            ...
            children: tabProps => {
              const [_, childProps] = splitProps(tabProps, ["title", "disabled", "tabClassName", "tabAttrs"]);
              return createComponent(TabPane$1, mergeProps$1(childProps, {
                get children() {
...
const ToastHeader = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$3, p), ["bsPrefix", "closeLabel", "closeVariant", "closeButton", "className", "children"]);
...
const _tmpl$$2 = template(`<div role="alert" aria-live="assertive" aria-atomic="true"></div>`, 2);
...
const Toast = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$2, p), ["bsPrefix", "className", "transition", "show", "animation", "delay", "autohide", "onClose", "bg"]);
  ...
  const ToastInner = () => (() => {
    ...
    effect(() => _el$.className = classNames(bsPrefix, local.className, local.bg && `bg-${local.bg}`, !hasAnimation && (local.show ? "show" : "hide")));
...
const ToastContainer = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$1, p), ["as", "bsPrefix", "position", "className"]);
  ...
  return createComponent(Dynamic, mergeProps$1({
    ...
    get className() {
      return classNames(bsPrefix, local.position && `position-absolute ${positionClasses[local.position]}`, local.className);
    },
...
const _tmpl$$1 = template(`<input autocomplete="off">`, 1);

const noop = () => undefined;

const ToggleButton = p => {
  const [local, props] = splitProps(p, ["bsPrefix", "name", "className", "checked", "type", "onChange", "value", "disabled", "id", "inputRef"]);
  ...
  return [(() => {
    ...
    get className() {
      return classNames(local.className, local.disabled && "disabled");
    },
...
const _tmpl$ = template(`<div role="tooltip"><div class="tooltip-arrow"></div><div></div></div>`, 6);
const defaultProps = {
  arrowProps: {},
  placement: "right"
};
...
const Tooltip = p => {
  const [local, props] = splitProps(mergeProps(defaultProps, p), ["bsPrefix", "placement", "className", "style", "children", "arrowProps", "popper", "show"]);
  ...
  return (() => {
    ...
    spread(_el$2, () => context?.arrowProps, false, true);

    insert(_el$2, () => context?.arrowProps?.children);
    ...
    effect(_p$ => {
      const _v$ = classNames(local.className, bsPrefix, `bs-tooltip-auto`),
            _v$2 = Object.assign({}, local.style, context?.wrapperProps.style);
